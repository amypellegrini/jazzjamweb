...
Write to `.claude/reports/assess-ci-<timestamp>.md` where `<timestamp>` is a filesystem-safe ISO-like value (e.g. `2026-05-08T14-30-00Z`). Create the directory if missing — it's gitignored.
