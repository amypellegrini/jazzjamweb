...
- The consolidated BA handoff report at `.claude/reports/qa-<timestamp>.md`.
...
- **Individual dimension reports** under `.claude/reports/` — one per assessed dimension.
- **Consolidated BA handoff report** at `.claude/reports/qa-<timestamp>.md` — plain English findings enumerated for Jira issue creation, one finding per actionable gap.
